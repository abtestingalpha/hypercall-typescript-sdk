...
function toViemTypedData(typedData) {
...
describe('signing helpers', () => {
  ...
  test('normalizes typed-data values the same way as the frontend helpers', () => {
    ...
    assert.deepEqual(buildReplaceOrderValue({
      wallet: WALLET,
      orderId: '123',
      symbol: 'BTC-260626-100000-C',
      side: 'Sell',
    ...
    assert.deepEqual(buildCancelOrderValue({
      wallet: WALLET,
      orderId: '123',
      nonce: 9,
    }), {
    ...
    assert.deepEqual(buildCancelOrderByClientIdValue({
      wallet: WALLET,
      clientId: 'client-2',
      nonce: 10,
    }), {
    ...
    assert.deepEqual(buildSetMarginModeValue({
      wallet: WALLET,
    ...
    assert.deepEqual(buildSetSettlementPayoutSeenValue({
      wallet: WALLET,
      ids: [1, 2, 3],
      nonce: 12,
    }), {
    ...
    assert.deepEqual(buildStandardMarginLiquidationOrderValue({
      wallet: WALLET,
    ...
    assert.deepEqual(buildWithdrawUsdcValue({
      wallet: WALLET,
      account: WALLET,
      destination: AGENT,
      amount: '500.00',
    ...
    assert.deepEqual(buildSubmitAutoExecuteRfqValue({
      rfqId: '0x1111111111111111111111111111111111111111111111111111111111111111',
      legsHash: '0x2222222222222222222222222222222222222222222222222222222222222222',
      limitPrice: -99n,
      wallet: WALLET,
  ...
  test('buildTypedData snapshots current signed write envelopes', () => {
    ...
    assert.deepEqual(buildTypedData({
      chainId: 998,
    ...
    const vectors = [
      {
        ...
        signature: '0x73c077c2c79c84e55e85e92b766a3a333237270daf117002f00264d4aa51750f06b7835cfa81358d634ce97dab8807c8f0f9b378800df894ddfc715f5901bbee1b',
      },
      {
        name: 'revokeAgent',
        typedData: buildTypedData({
      ...
      },
      {
        ...
        signature: '0xc66973933f9395012fc2e67e49e1b4178f076c5f6de2f6ec93a88127d5dad46f0a5b0503c9980eb73ca4ca071cde84e2584be6db4add8cd02e94f7dfc81c00111b',
      },
      {
        name: 'replaceOrder',
        typedData: buildTypedData({
        ...
        signature: '0x23627b4202016da7c182aaf3d8fa726013d8e0b8724f0f62b54e5c3df1f226c57437837b74390f6bc3f03624cdf4e6d910ca48d5666383cf2dff397c9c47e00b1b',
      },
      {
        name: 'cancelOrder',
        typedData: buildTypedData({
        ...
        signature: '0x73f80b98e6d91ff0395e28f62bca33150490e8cd7425e8d8de3593c6640343bc5014da27ac87c040c32d082d34c2943f6ffd39b2b9e0a59c178a17f85e94f60a1b',
      },
      {
        ...
        signature: '0x5eafaf3c1d3cfc5e5c25cb36ebfaa2d7328f3cf8dc2104257b5520fd1be5abc30a274cc4cdec79d49506d7cb3de3ef729386c5863ab2c8cbef2282804e2575341c',
      },
      {
        name: 'setMarginMode',
        typedData: buildTypedData({
        ...
        signature: '0x7ac635ff30959ee7f47044a3e305dd1d207625ebf61631bcc1b73f68f0ea86985ebb6b92e6098f2830a4e2be727905350c00979d7eaeb9f3cb4b4b912a7d05bd1c',
      },
      {
        ...
        signature: '0x01f8164dd358a4133bf6ee719e26a9dcb2f49583084998b969e2c77e26757ac67ec0a1dbaa28f26d7760733d513c642f4773eb77393b31c8d78b6d7b368f3bd91b',
      },
      {
        ...
        signature: '0x6dda08bbb3a2314ebb306a834a3f732effd243a998a66405d6cfbbd1a7daec4c0871d5151c4df3e617493df7d3ff6ae60f703af114719bcb20f155882a7651391c',
      },
      {
        name: 'withdrawUsdc',
        typedData: buildTypedData({
        ...
        signature: '0x6e004493fe836a216a717e175c7476782789fc3fbd675cac4d1bd0805f87ed6761b75184f77ec5f4b7f746dac228521dab09384b8d5c6e56387be65f29f132481b',
      },
      {
        name: 'submitRfq',
        typedData: buildTypedData({
        ...
        signature: '0x2b7262cdd5939e24c33f128f396c96e1e371edf72f7661dc132ab785de7bcbea39b992a0db115dadb646896b2f337ee5a7acecfb2160b0d52ef759c69d1d195a1b',
      },
      {
        ...
        signature: '0x40ebbe5a39ceb22dd56da4282d568763ffe32323170a24022b555c2da0fac4b91d29b0225291b8f702112a6283b5663c1975a518e6affde04bcaec1955b6bfb31c',
      },
      {
        name: 'acceptRfqQuote',
        typedData: buildTypedData({
        ...
        signature: '0xad0bc4765778e3ec0d3e61b1eaaaae530e3e50dd38fbac0cecfbf840b462e4b94a4d9df1cdfb98ff88f2616f5ffc89c0e1b6aad50b896e08d32c378c1daeaf2c1c',
      },
    ]
